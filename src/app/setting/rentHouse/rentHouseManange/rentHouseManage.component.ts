...
@Component({
  selector: 'app-rent-house-manage',
  templateUrl: './rentHouseManage.component.html',
  styleUrls: ['./rentHouseManage.component.css']
})
export class RentHouseManageComponent implements OnInit {
